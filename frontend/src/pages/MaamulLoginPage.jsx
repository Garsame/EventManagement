...
/**
 * Standalone door for the admin realm - no public navbar/footer, and this URL
 * is never linked from the public site.
 */
export default function MaamulLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-950 p-5">
      ...
      <div className="w-full max-w-sm">
        ...
        <Card>
          <h1 className="text-lg font-bold mt-0 mb-1 text-center">Administrator sign-in</h1>
          <p className="text-muted text-center mt-0 mb-5 text-sm">Restricted access</p>
          <form onSubmit={handleSubmit}>
            ...
            <p style={{ marginTop: "-0.5rem", marginBottom: "1rem", textAlign: "right" }}>
              <Link to="/maamul/forgot-password" className="text-sm font-semibold text-brand-600 dark:text-brand-300">
                Forgot password?
              </Link>
            </p>
