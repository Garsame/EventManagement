...
/** Same standalone shell as PhotographerLoginPage - no public navbar/footer. */
export default function PhotographerForgotPasswordPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-950 p-5">
      ...
      <div className="w-full max-w-sm">
        ...
        <Card>
          <h1 className="text-lg font-bold mt-0 mb-1 text-center">Reset your password</h1>
          <p className="text-muted text-center mt-0 mb-5 text-sm">We'll email a 6-digit code to confirm it's you.</p>
          <ForgotPasswordForm loginPath="/photographer/login" />
        </Card>
      </div>
    </div>
  );
